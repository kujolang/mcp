...
| `ssg` | `4df56ef475e81a8bfe5c98c6bd7d419663877b6d` | clean | Static-site Ability definitions and build contracts |
...
| SSG CI | `KUJO_BIN=…/kujo/target/release/kujo bash scripts/run_ci_checks.sh` | Passed CLI, generated-output, WebMCP, DocGen/docs template, Ability catalog, build, and HTML validation checks |
...
- The SSG Ability catalog validates producer definitions but does not yet prove an executable, receipt-producing pack adapter.
