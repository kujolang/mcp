...
checks.push(record("command-code-clean-profile", "command-code", "installed-configuration-validated", "KUJO_REQUIRE_COMMAND_CODE=1 node tests/command_code_clean_profile_test.mjs", command("node", ["tests/command_code_clean_profile_test.mjs"], root, { KUJO_REQUIRE_COMMAND_CODE: "1" }), ["Command Code accepted and resolved the project MCP configuration. Separate checked evidence records a model-driven Ollama Cloud invocation; this regularly regenerated tier remains configuration-only so it does not require provider credentials."]));
